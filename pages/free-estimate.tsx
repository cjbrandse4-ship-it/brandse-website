...
const copy = {
  en: {
    ...
    heroHeadline: 'Tree Removal in West Island & Vaudreuil — Quoted in 2 Hours',
  ...
  fr: {
    ...
    heroHeadline: 'Abattage d\'arbres dans l\'Ouest de l\'Île et Vaudreuil — Devis en 2 heures',
